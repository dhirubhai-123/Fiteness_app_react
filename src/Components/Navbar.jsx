    ...
    <>
      <div className="flex justify-around items-center py-3 bg-red-50">
        <div >
          <NavLink to="/" className='flex justify-center items-center' >
            <div>
              <img src="src\assets\assets\images\Logo.png" alt="img" />
            </div>
            <div className='text-3xl text-red-500 px-2 font-bold space-x-1 hover:cursor-pointer'>FitFusion</div>
          </NavLink>
        </div>
      ...
      <div className='flex w-full justify-between px-1 relative'>
        ...
        <div className='lg:w-[33vw] object-cover'>
          <img src="src\assets\assets\images\banner.png" alt="" />
        </div>
