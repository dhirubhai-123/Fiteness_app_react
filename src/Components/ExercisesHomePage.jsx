                    ...
                    allExercises.map((exercise) => (
                        <Grid item xs={12} sm={6} md={4} key={exercise.exerciseId}>
                            ...
                            >
                                ...
                                >
                                    <img src="src\assets\assets\icons\heart.png" alt="heart" className='hover:outline-1 hover:outline-dashed hover:outline-red-500 hover:rounded-md hover:bg-red-50' />
                                </div>
                        ...
                        <div className="relative bg-slate-800 rounded-lg shadow-lg h-full max-w-3xl w-full">
                            <div className="flex justify-between items-center p-4 border-b text-white">
                                ...
                                <div className='flex justify-between gap-x-2 items-center'>
                                    <img src="src\assets\assets\icons\heart.png" alt="heart" className='h-7 w-9 rounded-md hover:cursor-pointer bg-white px-1 hover:shadow-md hover:shadow-slate-400 hover:scale-110'
                                        onClick={(event) => {
